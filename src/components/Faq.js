  ...
  return (
    <div className='bg-gray-50'>
        <div className='p-16 grid min-[320px]:grid-cols-1 md:grid-cols-2'>
            ...
            <p>{langEng?'Can’t find the answer you’re looking for?':'आप जिस उत्तर की तलाश कर रहे हैं वह नहीं मिल रहा है?'} <br/>{langEng?'Reach out to our':'कृपया हमारी'} <span className='font-bold text-orange-500 cursor-pointer'>{langEng?'support':'सपोर्ट'}</span> {langEng?'team':'टीम से संपर्क करे'}</p>
            </div>
